...
<div id="registration_form_block" style="height: 970px">
    <?php Pjax::begin(['id' => 'reg-pjax']); ?>
    <?php
        //print_r($user);
    ?>
    ...
    <?php $form = ActiveForm::begin([
        ...
        'action' => Yii::getAlias('@web') . "/site/reg",
        'enableClientValidation' => true,
        'enableAjaxValidation' => true,
        'options' => ['class' => 'form-horizontal RegForm','data-pjax' => true],
        'fieldConfig' => [
    ...
    <div class="form-group">
        <div class="col-lg-11">
            <?= Html::Button('Back to login',['class' => 'btn btn-primary btn-change-lr']) ?>
        </div>
    </div>

            <b>Info for login (All fields are required):</b><br><hr><br>
            ...
            <b>General info (All fields are required):</b><br><hr><br>

            <?= $form->field($model, 'first_name', ['enableAjaxValidation' => true]) ?>
            <?= $form->field($model, 'second_name', ['enableAjaxValidation' => true]) ?>

            <div class="form-group field-registrationform-birth_day field-registrationform-birth_month field-registrationform-birth_year required">

                <label class="col-lg-2 control-label">Birthday</label>
                <div class="col-lg-5">
                    <select class="form-control bd_form mr5" id="dobday" name="RegistrationForm[birth_day]"></select>
                    <select class="form-control bd_form mr5" id="dobmonth" name="RegistrationForm[birth_month]"></select>
                    <select class="form-control bd_form" id="dobyear" name="RegistrationForm[birth_year]"></select>
                </div>
                <div class="col-lg-5"><p class="help-block">You have to be at least 16 years old to register</p></div>

            </div>
            <div class="form-group field-registrationform-country required">

                <label class="col-lg-2 control-label">Country</label>
                <div class="col-lg-5">
                    <select name="RegistrationForm[country]" id="country-selector">
                ...
                <div class="col-lg-5"><p class="help-block">Start type your country and then <u>choose</u> from list</p></div>

            </div>

            <br><br>

            <b>Battle.net info (* fields are required):</b><br><hr><br>

            <?= $form->field($model, 'character', ['enableAjaxValidation' => true]) ?>
            <?= $form->field($model, 'ingame_username', ['enableAjaxValidation' => true]) ?>
            <?= $form->field($model, 'ingame_clan', ['enableAjaxValidation' => true]) ?>
            <?= $form->field($model, 'ingame_league', ['enableAjaxValidation' => true]) ?>

    <input type="hidden" id="registration_all_valid" name="RegistrationForm[all_valid]" value="0">
    <div class="form-group">
        <div class="col-lg-11">
            <?= Html::submitButton('Register', ['class' => 'btn btn-success', 'name' => 'registration-button']) ?>
            <?php if (Yii::$app->session->hasFlash('regFillReq')): ?>
                <span style="margin-left: 10px; color: #A94442">Fill required fields!</span>
            <?php endif; ?>
            <?php if (Yii::$app->session->hasFlash('regError')): ?>
                <span style="margin-left: 10px; color: #A94442">Unknown error occurred, we are already working at this!</span>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        ...
        $("input.country-field").on('blur', function(){
            checkCountry();
        });
    </script>
    <?php Pjax::end(); ?>
